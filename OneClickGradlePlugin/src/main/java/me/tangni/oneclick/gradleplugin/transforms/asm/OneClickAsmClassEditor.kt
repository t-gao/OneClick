...
class OneClickAsmClassEditor(private val transform: OneClickTransform? = null) : CybertronClassEditor {
    ...
    override fun getEditedClassByteArray(cybertron: Cybertron,
        ...
        return if (interesting) {
            ...
            val classVisitor = OneClickClassVisitor(classWriter, cn, transform?.clickInterval?:0L)
